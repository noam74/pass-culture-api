...
class CatchingUpDMSBeneficiariesAddressesTest:
    def test_catching_up_dms_beneficiaries_addresses(self):
        # Given
        alice = users_factories.UserFactory(id=1, firstName="Alice", email="alice@example.com", address=None)
        bob = users_factories.UserFactory(id=2, firstName="Bob", email="bob@example.com", address=None)
