...
from pcapi.scripts.booking.notify_soon_to_be_expired_bookings import notify_soon_to_be_expired_non_eac_bookings
...
@log_cron
@cron_context
def pc_notify_soon_to_be_expired_non_eac_bookings(app: Flask) -> None:
    notify_soon_to_be_expired_non_eac_bookings()
...
def main() -> None:
    ...
    scheduler.add_job(
        pc_notify_soon_to_be_expired_non_eac_bookings,
        "cron",
        [app],
        day="*",
        hour="5",
